# Your application "NotesApp" and user pool "User pool - tyr88r" have been created successfully! Follow the instruction to continue the setup
...
const cognitoAuthConfig = {
  ...
  client_id: "4o53p02f1j4ofcbm4uekaovo8g",
...
function App() {
  ...
  const signOutRedirect = () => {
    const clientId = "4o53p02f1j4ofcbm4uekaovo8g";
